...
package com.kaifamiao.extra03.controller;

import com.kaifamiao.extra03.service.RagService;
...
public class CloudRagController {
    ...
    @GetMapping(value = "/cloudRag", produces = "text/html;charset=UTF-8")
    public Flux<String> generate(@RequestParam(value = "message",
            defaultValue = "百炼手机") String message) {
